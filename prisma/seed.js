...
async function seed() {
    ...
    await prisma_1.prisma.market.createMany({
        data: [
            // ALIMENTAÇÃO
            {
            ...
            },
            {
                ...
                categoryId: "52e81585-f71a-44cd-8bd0-49771e45da44",
                name: "BookMart",
                description: "Livraria especializada em best-sellers e clássicos. Espaço aconchegante para leitura.",
                latitude: -23.556376883488902,
                longitude: -46.65941413229616,
                coupons: 10,
                address: "Rua Luís Coelho - Consolação",
                phone: "(19) 9876-5432",
                cover: "https://images.unsplash.com/photo-1512436991641-6745cdb1723f?w=400&h=300",
            },
            {
                id: "78ced7b1-436b-42ca-9c66-747f2b671321",
                categoryId: "52e81585-f71a-44cd-8bd0-49771e45da44",
                name: "Green Market",
                description: "Produtos orgânicos e saudáveis para o seu dia a dia. Alimentos frescos e sustentáveis.",
                latitude: -23.55473446617852,
                longitude: -46.65859874077045,
                coupons: 10,
                address: "Rua Matias Aires - Consolação",
                phone: "(11) 8765-4321",
                cover: "https://images.unsplash.com/photo-1556740749-887f6717d7e4?w=400&h=300",
            },
            // HOSPEDAGEM
            {
                ...
                name: "Hotel Céu Azul",
                description: "Hotel moderno com quartos aconchegantes. Ideal para relaxar.",
            ...
            },
            {
                ...
                categoryId: "57d6e5ff-35f6-4d21-a521-84f23d511d25",
                name: "Casa Serena",
                description: "Pousada charmosa no coração da cidade, com ambiente tranquilo e serviço personalizado.",
            ...
            },
            {
                ...
                categoryId: "57d6e5ff-35f6-4d21-a521-84f23d511d25",
                name: "Suites Urban",
                description: "Acomodações sofisticadas no centro da cidade. Perfeito para viagens de negócios ou lazer.",
            ...
            },
            {
                ...
                categoryId: "57d6e5ff-35f6-4d21-a521-84f23d511d25",
                name: "Villa Encanto",
                description: "Chalés rústicos em uma área tranquila. Experiência de hospedagem exclusiva com total privacidade.",
            ...
            },
            {
                ...
                categoryId: "57d6e5ff-35f6-4d21-a521-84f23d511d25",
                name: "Estalagem Real",
                description: "Hotel boutique com design clássico e atendimento de excelência. Uma estadia luxuosa e confortável.",
            ...
            // CINEMA
            {
                ...
                name: "CineStar",
                description: "Cinema moderno com salas confortáveis e tecnologia de última geração.",
            ...
            },
            {
                ...
                categoryId: "826910d4-187d-4c15-88f4-382b7e056739",
                name: "MovieLand",
                description: "Espaço cultural com uma seleção variada de filmes e festivais exclusivos.",
            ...
            },
            {
                ...
                categoryId: "826910d4-187d-4c15-88f4-382b7e056739",
                name: "TelaMax",
                description: "Cinema de bairro com atmosfera aconchegante e opções de filmes clássicos e lançamentos.",
            ...
            // PADARIA
            {
                ...
                name: "Grão Dourado",
                description: "Famosa por seus croissants e pães de fermentação natural.",
            ...
            },
            {
                ...
                categoryId: "abce52cf-b33b-4b3c-8972-eb72c66c83e4",
                name: "Pão & Cia",
                description: "Padaria artesanal com pães frescos e quitutes caseiros todos os dias.",
            ...
            },
            {
                ...
                categoryId: "abce52cf-b33b-4b3c-8972-eb72c66c83e4",
                name: "Doce Massa",
                description: "Especializada em doces e salgados, com opções de café da manhã completo.",
            ...
            },
            {
                ...
                description: "Padaria de bairro com pães rústicos e tradicionais assados na hora.",
    ...
    await prisma_1.prisma.rules.createMany({
        data: [
            {
